...
describe('test Alert component', () => {
  ...
  it('should render the correct component based on different props', async () => {
    const { getByText, container } = render(<Alert {...successProps} type='success'></Alert>)
    expect(container.querySelector('.alert')).toBeInTheDocument()

    // 测试类型
    expect(container.querySelector(".alert")).toHaveClass("alert alert-success")
    ...
    const closeIcon = container.querySelector('.alert-close') as HTMLButtonElement
